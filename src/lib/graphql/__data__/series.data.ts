    ...
    series_posts: [
      ...
      },
      {
        ...
        post: {
          ...
          short_description:
            '3-1. 리덕스의 3가지 규칙\n\n리덕스를 프로젝트에서 사용하게 될 때 알아둬야 할 3가지 규칙이 있습니다.\n\n1. 하나의 애플리케이션 안에는 하나의 스토어가 있습니다.\n\n하나의 애플리케이션에선 단 한개의 스토어를 만들어서 사용합니다. 여러개의 스토어를 사용하는것은 사실 가능하기는 하나, 권장되지는 않습니다.  특정 업데이트가 너무 빈번하게 일어나거나, 애플...',
      ...
      },
      {
        ...
        post: {
          ...
          thumbnail:
            'https://images.velog.io/post-images/velopert/6d02a460-b352-11e8-b01f-598f1220d1c8/immutable-or-immer.png',
          short_description:
      ...
      },
      {
        ...
        post: {
          ...
          title: 'MobX (1) 시작하기',
          thumbnail:
            'https://images.velog.io/post-images/velopert/014d22d0-b353-11e8-9696-f1fffe8a36f1/mobx.png',
          short_description:
      ...
      },
      {
        ...
        post: {
          ...
          thumbnail:
            'https://images.velog.io/post-images/velopert/221f9500-b354-11e8-ba07-9dd972ee6ad1/mobx.png',
          short_description:
